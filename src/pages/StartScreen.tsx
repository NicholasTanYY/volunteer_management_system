  ...
  return (
    <div className="vh-100 d-flex flex-row justify-content-evenly">
      ...
      <div className="d-flex flex-column justify-content-center align-items-center border-start w-50">
        <h1>I am a...</h1>
        <Button variant="bg-light border border-dark w-25" className="m-2" onClick={() => navigate('/userLogin')}>Volunteer</Button>
        <Button variant="bg-light border border-dark w-25" className="m-2" onClick={() => navigate('/adminLogin')}>Admin</Button>
      </div>
    </div>
  );
};
