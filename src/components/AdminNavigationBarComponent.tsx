    ...
    <Navbar expand="lg" bg="light" variant="dark">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ms-auto">
          <Nav.Link className="text-dark" as={Link} to="/adminHome">Home</Nav.Link>
          <Nav.Link className="text-dark" as={Link} to="/adminEvents">Events</Nav.Link>
          <Nav.Link className="text-dark" as={Link} to="/adminReports">Reports</Nav.Link>
        </Nav>
      </Navbar.Collapse>
      <Nav className="ms-auto">
        <Dropdown>
